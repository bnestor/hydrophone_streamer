...
from supported_classes.ooi_streaming_class import OOIStreamingClass
# from supported_classes.onc__streaming_classes import ONCStreamingClass
...
def stream_data(
    ...
    if hydrophone_network == 'onc':
        streaming_class = ONCStreamingClass(stream_setting)
        ...
        streaming_class = OrcasoundStreamingClass(stream_setting)
    else:
